...
class AwsS3:
    ...
    def download_file(self, presigned_url, file_path, file_name):

        """
        This function is used to download file from AWS S3 bucket using S3 presigned URL and save it to local
        ...
        """
        try:
            self.s3_client.download_file(presigned_url, file_path, file_name)
            return True
        except ClientError as e:
            print(e)
            return False
